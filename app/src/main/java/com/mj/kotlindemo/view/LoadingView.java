package com.mj.kotlindemo.view;
...
public class LoadingView extends FrameLayout {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
         ...
         * 数据为空的布局
         */
        int emptyLayoutId = array.getResourceId(R.styleable.LoadingView_lv_empty_view, R.layout.default_empty_view);
        emptyImgId = array.getResourceId(R.styleable.LoadingView_lv_empty_img, 0);
        emptyString = array.getString(R.styleable.LoadingView_lv_empty_tv);
        //获取空布局View
        emptyView = View.inflate(context, emptyLayoutId, null);

        if (emptyLayoutId == R.layout.default_empty_view) {//如果是自带的布局
         ...
         * 数据错误时的布局
         */
        int errorLayoutId = array.getResourceId(R.styleable.LoadingView_lv_error_view, R.layout.default_error_view);
        errorImgId = array.getResourceId(R.styleable.LoadingView_lv_error_img, 0);
        errorString = array.getString(R.styleable.LoadingView_lv_error_tv);
        errorView = View.inflate(context, errorLayoutId, null);

        if (errorLayoutId == R.layout.default_error_view) {//如果是自带的布局
         ...
         * 数据加载时的布局
         */
        int loadingLayoutId = array.getResourceId(R.styleable.LoadingView_lv_loading_view, R.layout.default_loading_view);
        loadingImgId = array.getResourceId(R.styleable.LoadingView_lv_loading_img, 0);
        loadingString = array.getString(R.styleable.LoadingView_lv_loading_tv);
        loadingView = View.inflate(context, loadingLayoutId, null);

        if (loadingLayoutId == R.layout.default_loading_view) {//如果是自带的布局
